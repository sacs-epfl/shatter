...
class VNodeReal(VNode):
    ...
    def run(self):
        ...
        for iteration in range(self.iterations):
            ...
            for i, to_send in enumerate(to_send_list):
                ...
                to_send["vSource"] = self.vids[i]

                for neighbor in new_neighbors[i]:
            ...
            while not self.received_from_all():
                source, data = self.receive_Virtual()
    ...
    def instantiate(
        ...
        *args
        ...
        self.will_receive = self.vnodes_per_node * nodeConfigs["graph_degree"]
        self.log_models = (
        ...
        self.barrier = set()
        self.my_neighbors = [i for i in range(self.mapping.get_n_procs())]
