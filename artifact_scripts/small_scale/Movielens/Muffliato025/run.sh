...
nfs_home=$1
python_bin=$2
logs_subfolder="artifact_scripts/small_scale/Movielens/Muffliato025"
...
tests=("$nfs_home/$logs_subfolder/config_Muffliato025.ini")
